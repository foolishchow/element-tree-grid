...
export declare type TableColumnFixedType = 'left' | 'right';
...
export declare type ElementUIComponentSize = 'large' | 'medium' | 'small' | 'mini';
/** Horizontal alignment */
export declare type ElementUIHorizontalAlignment = 'left' | 'center' | 'right';
...
export declare type ElTableColumnProps = {
...
export declare type ElTableColumnPropsInner = {
    /** Type of the column. If set to `selection`, the column will display checkbox. If set to `index`, the column will display index of the row (staring from 1). If set to `expand`, the column will display expand icon. */
    type?: TableColumnType;
    /** Column label */
    label?: string;
